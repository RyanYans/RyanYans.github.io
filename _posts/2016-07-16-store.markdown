...
运行结果：  
![1.png](https://ooo.0o0.ooo/2016/07/16/578a13c399572.png)
...
在系统中得位置如下：  
![2.png](https://ooo.0o0.ooo/2016/07/16/578a13c3d15ce.png)
...
![3.png](https://ooo.0o0.ooo/2016/07/16/578a13c3c7368.png)

Context.getExternalFilesDir()和Context.getFilesDir()也是有区别的，但是在应用卸载的时候，也是会被删除的。

![4.png](https://ooo.0o0.ooo/2016/07/16/578a13c42406b.png)
...
下面就是这些参数对应的文件夹：  
![5.png](https://ooo.0o0.ooo/2016/07/16/578a13c41d0d9.png)
